...
public class VisitDaoImpl implements VisitDao{
    ...
    public Map<String,Object> findLifeAndPhysicalAndExamination(Integer memberId,String visitType)throws Exception{
         ...
         while(rowSet.next()){
        	 ...
        	 map.put("dailyDrink",rowSet.getDouble("DailyDrink"));
        	 map.put("dailyDrinkNext",rowSet.getDouble("DailyDrink_Next"));
         }
    ...
    public Integer hasHyperDetailRecord(Long hyperID)throws Exception{
        Integer id = null;
        String sql = " SELECT HypertensionID FROM ph_hypertensiondetail WHERE HypertensionID = ?  ";
        SqlRowSet rowSet = jdbcService.query(sql,new Object[]{hyperID});
        while(rowSet.next()){
            id = rowSet.getInt("HypertensionID");
        }
        return id;
    }
    ...
    public Integer hasDiabeteDetailRecord(Long diabetesID)throws Exception{
        Integer id = null;
        String sql = " SELECT DiabetesID FROM ph_diabetesdetail WHERE DiabetesID = ?  ";
        SqlRowSet rowSet = jdbcService.query(sql,new Object[]{diabetesID});
        while(rowSet.next()){
            id = rowSet.getInt("DiabetesID");
        }
        return id;
    }
    ...
    public void insertHyperDetailRecord(Long hyperID)throws Exception{
        String sql="insert into ph_hypertensiondetail (HypertensionID)VALUES(?)";
        jdbcService.doExecuteSQL(sql, new Object[]{hyperID} );
    }
    ...
    public void insertDiabeteDetailRecord(Long diabetesID)throws Exception{
        String sql="insert into ph_diabetesdetail (DiabetesID)VALUES(?)";
        jdbcService.doExecuteSQL(sql, new Object[]{diabetesID} );
    }
