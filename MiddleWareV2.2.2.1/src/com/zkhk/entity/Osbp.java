...
public class Osbp {
	...
	private String testTime;// 测量时间格式如：20141021143021

	private long eventId;// 测量记录ID

	private String abnormal; // 异常状态0 正常 1 低血压2 高度高血压3 中度高血压4 轻度高血压 5 单纯收缩高血压

	private int timePeriod;// 测量时间段 0 其他时间段 1 起床后2小时 2 睡觉前
